...
function Copyright() {
  return (
    <Typography variant="body2" color="text.secondary" align="center" sx={{ mt: 5, color: 'orange' }}>
      {'Copyright © '}
    ...
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: '80vh' }}>
        ...
        <Grid
          ...
          sx={{
            backgroundImage:
              'url(https://www.cisco.com/c/en/us/products/security/what-is-single-sign-on-sso/jcr:content/Grid/category_atl/layout-category-atl/anchor_info.img.png/1668556769405.png)',
